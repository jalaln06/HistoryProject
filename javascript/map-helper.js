        ...
        this.data = {
            ...
            "People":
                [
                    new HistoryObject(
                        52.370780475020425,
                        4.898003740685993,
                        "Петр 1 привезет его с собой в Россию строить корабли. Он будет заниматься строительством сначала в Воронеже, потом в Санкт-Петербурге, а еще позднее в Архангельске.",
                        "Выбе Геренс ",
            ...
            "AZOV":
                [
                    new HistoryObject(
                        ...
                        "После пребывания в Архангельске Петр 1 понял, что если он хочет сделать Россию морской державой помимо белого моря ему нужны еще моря. Он колебался между Балтийскими и Черными морями. Для создания черноморского флота им была поставлена амбициозная задача: Взятие Азова.В Воронеж были доставлены детали для кораблей из Преображенского.",
                        "Подготовка Первого Азовского похода",
                        new Date("1965").getUTCFullYear(),
                        "AZOV"
                    ),
                    new HistoryObject(
                        47.0967853232081, 39.32664623118006,
            ...
            "VORONEZH":
                [
                    ...
                    new HistoryObject(
                        ...
                        "В Воронеже начинается постройка Корабля\"Гото Предистинация\". По легенде царь сам сделал его чертеж",
            ...
            "SHIPS":
                [
                    new HistoryObject(
                        ...
                        "В Воронеже начинается постройка Корабля\"Гото Предистинация\". По легенде царь сам сделал его чертеж",
                        "Начало строительства Гото Предистинации",
                        "19 november 1668",
                        "SHIPS"
                    ),
                    new HistoryObject(
                        51.579733513530535, 39.18359818819784,
                        "Закончилось строительство первого российского линейного корабля, а также первым кораблем такого класса созданного в России без иностранных специалистов",
                        "Закончилось строительство Гото Предистинации\n",
                        "27 april 1668",
                        "SHIPS"
                    ),
                    new HistoryObject(
            ...
            "SPB":
                [
                    ...
                    new HistoryObject(
                        ...
                        "В этот день в этом месте был основан Санкт-Петербург. Впоследствии ставший морской столицей России.",
                        "Санкт-Петербург\n",
                        "16 (27) may 1703",
                        "SPB"
                    ),
            ...
            "Battles":
                [
                    ...
                    new HistoryObject(
                        60.716896780851854, 28.72137426167534,
